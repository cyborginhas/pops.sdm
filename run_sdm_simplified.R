...
tiles <- list.files("C:/Users/blaginh/Desktop/maximize/tiles/", pattern = ".tif", full.names = TRUE)
...
for (i in seq_along(tiles)) {
  ...
  writeRaster(ind_p$max, paste0("C:/Users/blaginh/Desktop/maximize/Ailanthus_altissima_prediction",fn))
  t <- Sys.time() - s
  print(t)
